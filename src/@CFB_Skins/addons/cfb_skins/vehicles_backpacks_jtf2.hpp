...
class CFB_JTF2_Backpack_Assault : B_AssaultPack_blk
{
	...
	author = "Anton Struyk";
	// picture = "\cfb_skins\ui\CFB_JTF2_Backpack_Assault.paa";
...
class CFB_JTF2_Backpack_Kitbag : B_Kitbag_rgr
{
	...
	author = "Anton Struyk";
	// picture = "\cfb_skins\ui\CFB_JTF2_Backpack_Kitbag.paa";
...
class CFB_JTF2_Backpack_Carryall_AT : B_Carryall_oli
{
	scope = 1;
	scopeCurator = 1;
	class TransportMagazines
...
class CFB_JTF2_Backpack_Carryall_AA : B_Carryall_oli
{
	scope = 1;
	scopeCurator = 1;
	class TransportMagazines
